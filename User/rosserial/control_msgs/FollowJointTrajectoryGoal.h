...
class FollowJointTrajectoryGoal : public ros::Msg
{
  public:
    ...
    {
//        printf("deserialize trajectory...\n");
        int offset = 0;
        offset += this->trajectory.deserialize(inbuffer + offset);
//        printf("deserialize trajectory %d\n", this->trajectory.points_length);
...
//        printf("path_tolerance_length=%d\n", path_tolerance_length);
        
//        printf("deserialize path_tolerance...\n");
        for (uint32_t i = 0; i < path_tolerance_length; i++)
        {
            offset += this->st_path_tolerance.deserialize(inbuffer + offset);
            memcpy((void *)&(this->path_tolerance[i]), (void *)&(this->st_path_tolerance), sizeof(control_msgs::JointTolerance));
        }
//        printf("deserialize path_tolerance OK\n");
        ...
        for (uint32_t i = 0; i < goal_tolerance_length; i++)
        {
            ...
            memcpy((void *)&(this->goal_tolerance[i]), (void *)&(this->st_goal_tolerance), sizeof(control_msgs::JointTolerance));
        }
